                        ...
                        <div class="col-md-12">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Form Edit RWF</h3>
                                    <form action="/sayaplwf/update/<?= $data_lwf['id']; ?>" method="post"
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="<?= (old('kode')) ? old('kode') : $data_lwf['kode'] ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="<?= (old('nama')) ? old('nama') : $data_lwf['nama'] ?>">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="jenis" name="jenis"
                                                value="<?= (old('jenis')) ? old('jenis') : $data_lwf['jenis'] ?>">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="nilai" name="nilai"
                                                value="<?= (old('nilai')) ? old('nilai') : $data_lwf['nilai'] ?>">
                                            <div class="invalid-feedback">
