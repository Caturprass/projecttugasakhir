...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Edit Data RightBack</h1>
                </div>
            </div>
                        ...
                        <div class="col-md-12">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Form Edit RB</h3>
                                    <form action="/rightback/update/<?= $data_rb['id']; ?>" method="post"
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="<?= (old('kode')) ? old('kode') : $data_rb['kode'] ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="<?= (old('nama')) ? old('nama') : $data_rb['nama'] ?>">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="jenis" name="jenis"
                                                value="<?= (old('jenis')) ? old('jenis') : $data_rb['jenis'] ?>">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="nilai" name="nilai"
                                                value="<?= (old('nilai')) ? old('nilai') : $data_rb['nilai'] ?>">
                                            <div class="invalid-feedback">
