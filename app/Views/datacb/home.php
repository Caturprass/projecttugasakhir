            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <a href="/centerback/create" class="btn btn-primary">Tambah Kriteria CB</a>
                    </ol>
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $p['nilai']; ?></td>
                                <td>
                                    <form action="/centerback/edit<?= $p['id']; ?>">
                                        <button class="nav-icon fas fa-edit"></button>
                                    </form>

                                    <form action="/centerback/<?= $p['id']; ?>" method="post" class="d-inline">
