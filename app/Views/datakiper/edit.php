...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Edit Data Kiper</h1>
                </div>
            </div>
                        ...
                        <div class="col-md-12">
                            <div class="card card-primary">
                                <div class="card-header">
                                    ...
                                    <form action="/kiper/update/<?= $data_gk['id']; ?>" method="post"
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="<?= (old('kode')) ? old('kode') : $data_gk['kode'] ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="<?= (old('nama')) ? old('nama') : $data_gk['nama'] ?>">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="jenis" name="jenis"
                                                value="<?= (old('jenis')) ? old('jenis') : $data_gk['jenis'] ?>">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="nilai" name="nilai"
                                                value="<?= (old('nilai')) ? old('nilai') : $data_gk['nilai'] ?>">
                                            <div class="invalid-feedback">
