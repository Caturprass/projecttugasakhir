                        ...
                        <div class="col-md-12">
                            <div class="card card-primary">
                                <div class="card-header">
                                    ...
                                    <form action="/sayaprwf/update/<?= $data_rwf['id']; ?>" method="post"
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="<?= (old('kode')) ? old('kode') : $data_rwf['kode'] ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="<?= (old('nama')) ? old('nama') : $data_rwf['nama'] ?>">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="jenis" name="jenis"
                                                value="<?= (old('jenis')) ? old('jenis') : $data_rwf['jenis'] ?>">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="nilai" name="nilai"
                                                value="<?= (old('nilai')) ? old('nilai') : $data_rwf['nilai'] ?>">
                                            <div class="invalid-feedback">
