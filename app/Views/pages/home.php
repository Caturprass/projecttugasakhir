                        ...
                        <div class="col-12">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h4 class="card-title">DAFTAR PEMAIN AC.MILAN</h4>
                                </div>
                                <div class="card-body">
                                    <div>
                                        ...
                                        <div class="filter-container p-0 row">
                                            <div class="filtr-item col-sm-2" data-category="1" data-sort="white sample">
                                                <a href="https://via.placeholder.com/1200/FFFFFF.png?text=1"
                                                    ...
                                                    <img src="/img/arema.jpeg" class="img-fluid mb-2"
                                                        alt="white sample" />
                                                </a>
                                            </div>
                                            ...
                                            <div class="filtr-item col-sm-2" data-category="3, 4"
                                                data-sort="red yellow">
                                                <a href="https://via.placeholder.com/1200/FFD700/FFFFFF.png?text=4"
                                                    data-toggle="lightbox" data-title="sample 4 - yellow">
                                                    <img src="https://via.placeholder.com/300/FFD700/FFFFFF?text=4"
                                                        class="img-fluid mb-2" alt="yellow sample" />
                                                </a>
                                            </div>
                                            <div class="filtr-item col-sm-2" data-category="2, 4"
                                                data-sort="black sample">
